...
A fully responsive, modern portfolio website built with React, Vite, Tailwind
CSS, shadcn UI, Lenis smooth scrolling, GSAP animations, and Framer Motion.

## 🚀 Live Demo

- **Development**: https://obaidul-islam-portfolio.netlify.app/
...
The color scheme is defined in `tailwind.config.js` and can be easily
customized:
